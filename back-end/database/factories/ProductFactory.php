...
class ProductFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        return [
            ...
            'status' => $faker->randomElement(['T', 'P', 'D']),
            ...
            'quantity' => $faker->numberBetween(10, 20000),
            ...
            'serving_quantity' => $faker->randomFloat(2, 1, 10),
            'nutriscore_score' => $faker->numberBetween(0, 100),
            'nutriscore_grade' => $faker->randomElement(['A', 'B', 'C', 'D', 'E']),
